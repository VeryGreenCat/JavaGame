...
public class ImpossibleLevel extends JPanel implements Runnable {
    ...
    private final int BIRD_COUNT_MAX = 1;
    private final int GRAY_BIRD_COUNT_MAX = 8;
    private final int METEORITE_COUNT_MAX = 6;
    private final int BULLET_COUNT_MAX = 50;
    private final int PLANE_COUNT_MAX = 1;
    private final int GAME_TIMER = 30;

    private Player player;
    private int scorePoint;

    public ImpossibleLevel() {
        setLayout(null);
        font20 = new Font("Arial", Font.BOLD, 20);

        // Level title label
        JLabel jlbLevel = new JLabel("Impossible");
        jlbLevel.setBounds(10, 8, 120, 20);
    ...
    protected void paintComponent(Graphics g) {
        ...
        try {
            ...
            g2d.drawImage(ImageIO.read(getClass().getResourceAsStream("/background/Bg4.png")), 0, 0, screenWidth, screenHeight, this);
