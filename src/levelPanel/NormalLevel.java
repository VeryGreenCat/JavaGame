...
public class NormalLevel extends JPanel implements Runnable {
    ...
    public void stop() {
        running = false;
        System.out.println("levelPanel.NormalLevel.stop()");
    }
    ...
    public void run() {
        ...
        while (running) {
            ...
            System.out.println("levelPanel.NormalLevel.run()");
        }
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        try {
            g2d.drawImage(ImageIO.read(new File("D:\\Java\\GameProject\\src\\background\\Bg2.png")), 0, 0, getWidth(), getHeight(), this);
